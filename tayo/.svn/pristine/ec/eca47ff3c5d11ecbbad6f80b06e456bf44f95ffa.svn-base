...
jindo.$Jindo.checkVarType._throwException = function(aArgs, oRules, sFuncName) {
    ...
    if (/(\$\w+)#(\w+)?/.test(sFuncName)) {
        sURL = 'http://jindo.dev.naver.com/docs/jindo/archive/Jindo2-2.8.0/desktop/ko/classes/' + encodeURIComponent(RegExp.$1) + '.html' + "#method_"+RegExp.$2;
    }
...
jindo.$Ajax.SWFRequest.write = function(swf_path) {
    ...
    var classid = (_JINDO_IS_IE?'classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"':'');
