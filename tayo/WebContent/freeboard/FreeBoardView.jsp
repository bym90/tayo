                           ...
                           <div class="panel-body">
                               <table class="table" id="t${reple.no}">
									<tr>
										...
										<td><a href="./FreeBoardRepleDelete.do?no=${reple.no }&reno=${DATA.no}&page=${PAGE}&category=${reple.category}">삭제</a></td>
									</tr>
									<tr>
										<th>작성자</th>
										<td>${reple.writer }</td>
										<th>작성IP</th>
										<td>${reple.ip }</td>
										<td><a href="#" onclick="board.freeBoardRepleModify(${reple.no}); return false;">수정</a></td>
									</tr>
									<tr>
									...
									<table class="table" id="m${reple.no}" style="display:none;">
										...
										<tr>
											<td colspan="2" align="center">
												<a href="#" class="btn btn-warning" onclick="board.freeBoardRepleModifyProc(${reple.no}); return false;">댓글 수정하기</a>
											</td>
										</tr>
									</table>
								</form>
